...
class SimpleToastMessages {
     ...
     * ```
     */
    async show(message, type, toastSettings) {
        const messageElement = this.renderMessage(message, type, toastSettings);
        const messageContainer = (document.getElementById("stm_message_container"));
     ...
     * @returns refresh
     */
    async refresh(messageContainer) {
        const state = true;
        while (state) {
     ...
     * ```
     */
    renderMessage(message, type, toastSettings) {
...
export { Info };
//# sourceMappingURL=SimpleToastMessages.js.map